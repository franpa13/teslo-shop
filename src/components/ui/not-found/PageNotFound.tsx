  ...
  return (
    <div className="flex flex-col-reverse md:flex-row h-[500px] w-full justify-center items-center align-middle">
      <div className="text-center px-5 mx-5">
        <h2 className={`${titleFont} antialiased text-5xl sm:text-9xl`}>404</h2>
      ...
      <div className="px-5 mx-5 ">
       <Image src={"/imgs/starman_750x750.png"} alt="starman" width={550} height={550} className="p-5 sm:p-0"></Image>
      </div>
    </div>
  );
};
